...
class GameInfoBuilder(Builder[GameInfo]):
	...
	def getNbOfPlayers(self):
		players = dict(
			dpath.get(self.__data, "/response/jeu/joueurs", default=[])
		)
		default = ""
		if players is None:
			return default
	...
	def getEditor(self):
		editor = dict(
			dpath.get(self.__data, "/response/jeu/editeur", default=[])
		)
		default = ""
		if editor is None:
			return default
	...
	def getSynopsis(self):
		synopsis = list(
			dpath.get(self.__data, "/response/jeu/synopsis", default=[])
		)
		default = ""
	...
	def getGenres(self):
		genres = list(
			dpath.get(self.__data, "/response/jeu/genres", default=[])
		)
		res = []
		if genres is None:
			return res
	...
	def getMedias(self):
		medias = list(
			dpath.get(self.__data, "/response/jeu/medias", default=[])
		)
